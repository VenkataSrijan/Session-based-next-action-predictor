...
if __name__ == '__main__':
    ...
    model     = SASRec(num_items=len(le.classes_)).to(device)
    ...
    torch.save(model.state_dict(), "src/sasrec_model.pth")
    with open("src/sasrec_label_encoder.pkl", "wb") as f:
        pickle.dump(le, f)

    print("\nSASRec model and label encoder saved.")